...
async def button_cb(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == 'connect':
        ...
        kb = [[InlineKeyboardButton('🌐 WalletConnect', url=url)],
              [InlineKeyboardButton('❌ Cancel', callback_data='cancel')]]
        await q.edit_message_text('Open your wallet app (it will ask permission).',
        ...
        try:
            ...
            for o in list(lot):
                ...
                if (o['side'] == 'BUY' and price <= float(o['target'])) or (
                    ...
                    try:
                        asyncio.run(app.bot.send_message(int(o['user_id']),
